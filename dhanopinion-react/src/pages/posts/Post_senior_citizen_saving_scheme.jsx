  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>An account holder may operate more than one account under this Scheme subject to the condition that the deposits in all the accounts taken together shall not exceed the maximum limit of ₹ 30 lakh.</li>
        <li>The account can be opened by a person who has reached the age of 60. This is lowered, with some conditions, to:
          <ul>
            <li>55 for people who have retired under Superannuation, VRS or Special VRS.</li>
            <li>50 for retired Defence Services personnel</li>
          </ul>
        </li>
        <li>Interest is paid on the first working day of the calendar quarter for the previous quarter.</li>
        <li>On expiry of the account on completion of 5 years, the account can be closed or extended for another 3 years. After closure a SCSS account can be opened once again, if needed.</li>
      </ul>
