...
export default function CaseStudy1() {
  return (
    <PostLayout title="Case 1">
      ...
      <p className="t-body mb-3">With a higher target allocation to equities, our recommendation is:</p>
      <ol>
        <li>Switch savings account balances of 200,000 to Prudential Liquid Fund Direct Growth</li>
        <li>Sell their Prudential Balanced Fund</li>
        <li>Reinvest the 300,000 as follows:
          <ul>
            <li>50,000 in the Tier 1 National Pension Scheme (and repeat annually). Put 75% in the scheme Tier 1 Equity and 25% in Tier 1 Govt Securities. Pick State Bank of India as the investment provider.</li>
            <li>2,50,000 in the SBI Nifty Index ETF Direct Class</li>
          </ul>
        </li>
      </ol>

      <h2>Logic for the NPS</h2>
      <p className="t-body mb-5">
      ...
      <h2>Rationale for the SBI Nifty Index ETF Direct Class</h2>
      <p className="t-body mb-5">
        The SBI Nifty Index is the largest ETF in India. It gives you exposure to the Nifty Fifty which is the 50 largest companies in India. This covers the largest companies in India and the ones most likely to benefit from the projected growth of the economy and the consumer. The fees are very low at 0.04% for the direct class in comparison with about 1% for the average large capitalisation equity fund.
      </p>
      <p className="t-body mb-5">
