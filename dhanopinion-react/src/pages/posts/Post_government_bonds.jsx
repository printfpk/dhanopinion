...
export default function Post_government_bonds() {
  ...
  return (
    ...
    >
      <p style={{ color: 'var(--post-title)', fontWeight: '600' }}>April 13, 2026</p>
      ...
      <h3 className="t-h3 mt-10 mb-4">Types of Bonds</h3>
      <p>Both the central and state governments can issue bonds of different types:</p>

      <p className="font-bold text-white mt-4">Fixed-rate bonds</p>
      ...
      <p className="font-bold text-white mt-4">Floating Rate Bonds (FRBs)</p>
      ...
      <p className="font-bold text-white mt-4">Sovereign Gold Bonds (SGBs)</p>
      ...
      <p className="font-bold text-white mt-4">Inflation-Indexed Bonds</p>
      ...
      <p className="font-bold text-white mt-4">Treasury Bills (T-Bills)</p>
      <p>Bonds issued for under a year are known as T-Bills.</p>

      <p className="font-bold text-white mt-4">7.75% GOI Savings Bond</p>
      ...
      <p className="font-bold text-white mt-4">Tax free Bonds</p>
      ...
      <p className="font-bold text-white mt-4">Zero coupon Bonds</p>
      ...
      <div style={{ overflowX: 'auto', marginBottom: 'var(--sp-8)', borderRadius: 12, border: '1px solid var(--hairline)', background: 'rgba(255,255,255,0.02)' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 700 }}>
          <thead>
            <tr>
              <th style={{ ...thStyle, textAlign: 'left' }}>Scheme Name</th>
              <th style={{ ...thStyle, textAlign: 'center' }}>AuM (Cr.)</th>
              <th style={{ ...thStyle, textAlign: 'center' }}>1Y</th>
              <th style={{ ...thStyle, textAlign: 'center' }}>5Y</th>
              <th style={{ ...thStyle, textAlign: 'center' }}>10Y</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((r, i) => (
              ...
              >
                ...
                <td style={{ ...tdStyle, color: 'var(--smoke)', textAlign: 'center' }}>{r.aum}</td>
                <td style={{ ...tdStyle, color: 'var(--smoke)', textAlign: 'center' }}>{r.y1}</td>
                <td style={{ ...tdStyle, color: 'var(--smoke)', textAlign: 'center' }}>{r.y5}</td>
                <td style={{ ...tdStyle, color: 'var(--smoke)', textAlign: 'center' }}>{r.y10}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <h3 className="t-h3 mt-10 mb-4">Conclusion</h3>
