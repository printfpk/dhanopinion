...
export default function Post_equity_investing() {
  return (
    <PostLayout title="Equity Investing">
...
<div id="primary" class="content-area">
			...
			<div data-elementor-type="single-post" data-elementor-id="1192" class="elementor elementor-1192 elementor-location-single post-2006 post type-post status-publish format-standard hentry category-asset-allocation category-goal tag-equity tag-investment" data-elementor-post-type="elementor_library">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div data-elementor-type="wp-post" data-elementor-id="2006" class="elementor elementor-2006" data-elementor-post-type="post">
									<section class="elementor-section elementor-top-section elementor-element elementor-element-469a2b4 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="469a2b4" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-1f5a0ea" data-id="1f5a0ea" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-da98de9 elementor-widget elementor-widget-text-editor" data-id="da98de9" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
							<p>Equity is designed to bear risk in bad times.</p><p>When you invest in equity you take the risk that the business will be unsuccessful and that you will lose money. The only reason that people invest in equity is because they expect on average that the business will be successful and that they will make money in compensation for bearing this risk.  Historically equity markets have delivered high returns. It is reasonable to expect that in the future too, one should expect to get higher returns for bearing equity risk. However, when one invests in equity, one is taking risk while hoping to generate higher returns than fixed income investments and interest rate investments like government or corporate bonds or bank fixed deposits. </p>						</div>
				</div>
					</div>
		</div>
							</div>
