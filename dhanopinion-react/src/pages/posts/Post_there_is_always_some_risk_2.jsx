...
export default function Post_there_is_always_some_risk_2() {
  return (
    <PostLayout title="There is always some risk">
      <div dangerouslySetInnerHTML={{ __html: `
        ...
        <!-- 1.3 uicore_page -->			<div id="content" class="uicore-content">
          ...
          itemtype="https://schema.org/ListItem" ><span><span itemprop="name">There is always some risk</span><meta itemprop="position" content=" 4" /></span></span></p>
                            < class="uicore-title uicore-animate h2">
                                There is always some risk                            <>
                            <div class="uicore-animate uicore-entry-meta"><span class="ui-blog-date ui-published">January 9, 2023 </span></div>                    </div>

                </header>
                <!-- 1.4 uicore_before_content -->
<div id="primary" class="content-area">

			<div data-elementor-type="single-post" data-elementor-id="1192" class="elementor elementor-1192 elementor-location-single post-1873 post type-post status-publish format-standard hentry category-asset-allocation category-investment-strategy category-risk-and-return tag-investment tag-risk tag-safety" data-elementor-post-type="elementor_library">
