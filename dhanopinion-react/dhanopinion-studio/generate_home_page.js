...
const homePage = {
  _id: 'homeSingleton',
  _type: 'homePage',
  heroTitle: 'Investing is Difficult',
  heroSubtitle: 'It is difficult for large institutions, and it is even more difficult for individuals because they have less knowledge and resources. You can make it easier by evaluating our suggestions and if you are convinced, implement them.',
  focusPills: [
  ...
  scopeTitle: 'Scope',
  scopeText: 'The current scope covers financial assets such as mutual funds, government sponsored financial instruments and fixed deposits.',
  expectationsTitle: 'What you can expect',
  expectations: [
    { _key: 'ex1', heading: 'Better Strategy', desc: 'Creation of a better match between your goals, circumstances and preferences and your investments.' },
    { _key: 'ex2', heading: 'Reduced Complexity', desc: 'Reduced investing complexity and better understanding of investment choices.' },
    { _key: 'ex3', heading: 'Improved Returns', desc: 'Improved returns — a little.' },
    { _key: 'ex4', heading: 'Reduced Risk', desc: 'Reduced risk — a little.' }
  ],
  notExpectationsTitle: 'What you should not expect',
  notExpectations: [
    { _key: 'nex1', heading: 'Exponential Returns', desc: 'Substantial improvement in returns.' },
    { _key: 'nex2', heading: 'Elimination of Risk', desc: 'Elimination, or substantial reduction of the risk of loss.' },
    { _key: 'nex3', heading: 'Reduced Stress', desc: 'Reduced stress in investing.' }
  ],
